...
import { IAlbumUpsertRequestForm } from './album-upsert-request.form';

export function AlbumUpsertRequestFormGroupFac(): FormGroup<IAlbumUpsertRequestForm> {
  return new FormGroup<IAlbumUpsertRequestForm>({
